...
//
    ...
    private SequenceParser<String, ?, Tuple2<String,IpRange>> allowDecl =
            new SequenceParser(
    ...
    private SequenceParser<String, ?, Tuple2<String, IpRange>> denyDecl =
            new SequenceParser(
    ...
    private ChoiceParser<List<String>, Boolean, Boolean> orderChoice =
            new ChoiceParser<>(Arrays.asList(allowDeny, denyAllow), val -> val);
    // orderDecl : ORDER orderChoice
    private Parser<String, String> orderParser2 = orderParser;
    private Parser<? extends Object, ? extends Object> orderChoice2 = orderChoice;
    ArrayList<Parser<? extends Object, ? extends Object>> parsers = null;

//    private SequenceParser<? extends Object, ? extends Object, Boolean> orderDecl =
